...
function HomeDisconnected() {
  ...
  return (
    <div className="relative min-h-[calc(100vh-4rem)] overflow-hidden bg-emerald-50 dark:bg-slate-900">
      ...
      />
      <div className="absolute inset-0 z-0 bg-gradient-to-b from-emerald-100/90 via-emerald-50/85 to-lime-50/80 dark:from-slate-950/90 dark:via-slate-950/70 dark:to-slate-950/50" />
